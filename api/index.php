...
$workshops = [
    ...
    ["title" => "Exercice 15", "atelier" => "8", "code" => "https://github.com/ayaFrijo/atelier8.git", "pdf" => "Rapport Exercice151.pdf"],
    ...
    ["title" => "Exercice 20", "atelier" => "13", "code" => "https://github.com/ayaFrijo/atelier13.git", "pdf" => "At13.pdf"],
    ["title" => "burgerStore", "atelier" => "14", "code" => "https://github.com/ayaFrijo/atelierBurger.git", "pdf" => "burger_code (1).pdf"],
    ["title" => "Exercice 21", "atelier" => "15", "code" => "https://github.com/ayaFrijo/atelier15.git", "pdf" => "At15.pdf"]
...
<body>
    ...
    <section id="home">
        ...
        <div class="hero-image">
            <img src="profile.png" alt="Aya Frijo" style="width: 320px; border-radius: 20px; border-radius:60px box-shadow:0 0 20px #7c3ea0;border: 4px solid var(--accent-purple);">
        </div>
    </section>
